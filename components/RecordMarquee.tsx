...
const MarqueeItem = ({ product }: { product: any }) => (
  // Using mx-16 spacing to prevent overlap when vinyl slides out
  <div className="mx-16 transform scale-75 origin-top hover:scale-90 transition-transform duration-300">
