...
export default function VinylDisplay({ 
  ...
  return (
    <div className="group relative w-64 h-64 md:w-72 md:h-72 cursor-pointer mx-auto">
      ...
      {/* 1. The Vinyl Disc - SMOOTH HOVER ONLY (No continuous spin) */}
      <div className={`
          absolute top-2 right-2 w-[90%] h-[90%] rounded-full bg-black flex items-center justify-center 
          transition-transform duration-500 ease-out shadow-xl 
          ${!isSoldOut ? 'group-hover:translate-x-12 group-hover:rotate-90' : ''}
      `}>
